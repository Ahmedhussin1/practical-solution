...
function Work() {
  ...
  return (
    <div>
        {/* hero section */}
        <Hero img={specificObject.img} title={specificObject.title} description={specificObject.description} />
        {/* numbers */}
        <Numbers/>
        {/* word about us */}
        <AboutCompany/>
        ...
        {/* challenges faced */}
        <Challenges/>
       <div className="divider-container"> <hr className="work-section-divider"/></div>
        {/* services provided */}
        <WorkServices/>
        {/* approaches  */}
        {/* content marketing */}
